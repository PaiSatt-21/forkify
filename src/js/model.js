import { API_URL, RESULTS_PER_PAGE, DEFAULT_PAGE, KEY } from './config.js';
...
export const loadSearchResult = async function (query) {
  try {
    ...
    // reset page to default on load search result again
  ...
  try {
    const ingredients = Object.entries(newRecipe)
      ...
      .map(ing => {
        ...
        if (ingArr.length !== 3) throw new Error('Worng Ingredients Format!');
